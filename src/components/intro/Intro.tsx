...
const Intro = () => {
    ...
    return (
        <div className="intro">
            ...
            <div className="text">
                <p id="name">Shreya <strong>Hiremath</strong></p>
                <p className="title">Just one random learner and full time tech nerd ♡</p>

                <p>  A logical and creative thinker, I love solving problems. <br />   
                    Machine learning practitioner, <br />web and CV application developer.</p>
                ...
                <div className="socials">
                    ...
                    <div data-aos="zoom-in" data-aos-anchor-placement="center-bottom" data-aos-duration="1000">
                        <a href="https://github.com/shreya664" target="_blank" title="Github">
                    ...
                    <div data-aos="zoom-in" data-aos-anchor-placement="center-bottom" data-aos-duration="1300">
                        <a href="https://www.linkedin.com/in/shreya-hiremath-8aa43b1b2" title="Linkedin">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <div data-aos="zoom-in" data-aos-anchor-placement="center-bottom" data-aos-duration="1900">
                        <a href="mailto:shreya.hiremath19@vit.edu" target="_blank" title="Email">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                <path className="fill" d="M17 13.5c0 4.142-2.502 4-6.645 4-4.142 0-8.355.142-8.355-4S7.858 7 12 7s5 2.358 5 6.5z"></path>
