                ...
                <div data-aos="fade-left" data-aos-duration="1500" className="boxed card">
                    <p>
                        <span className="about-intro">
                            Forever a learner,<br /> 
                            moreover an applier, <br />
                            ALMOST always ready for new hurdles.
                        </span>
                        <br />
                        ...
                        <i>Actively looking for internships and full
                            time opportunities in IT sector.
                            <br /> also up for collaborating on projects
                            <br/>or simply have a virtual coffee over tech chitchat or coding contest,
